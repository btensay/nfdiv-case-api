export const reasonsForDivorce = {
  ADULTERY: 'adultery',
...
export const currentCaseType = 'NO_FAULT_DIVORCE17';

export const soleOrJoint = {
  SOLE: 'SoleApplicant',
...
export const serviceApplicationType = {
